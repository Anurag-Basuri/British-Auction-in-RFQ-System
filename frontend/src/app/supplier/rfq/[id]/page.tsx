              ...
              {rfq.status === "CLOSED" ? (
                <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-xl text-red-400 flex items-center gap-3">
                  ...
                  <span className="font-medium">
                    This auction has concluded. Bidding is disabled.
                  </span>
                </div>
              ) : (
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  {bidSuccess && (
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className="bg-green-500/10 border border-green-500/20 text-green-400 p-3 rounded-xl text-sm text-center font-medium"
                    >
                ...
                {sortedBids.map((bid, i) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p
                          className={`font-bold text-sm ${bid.supplierId === user?.id ? "text-indigo-400" : "text-white"}`}
                        >
                          {bid.supplierId === user?.id
                            ? "YOU"
                    ...
                    <p
                      className={`text-lg font-mono font-black ${i === 0 ? "text-green-400" : "text-white"}`}
                    >
                      ${bid.price.toFixed(2)}
                    </p>
                  </motion.div>
